...
CREATE INDEX IF NOT EXISTS idx_children_patient ON children(patient_id);
...
CREATE INDEX IF NOT EXISTS idx_function_calls_conversation ON function_calls(conversation_id);
CREATE INDEX IF NOT EXISTS idx_function_calls_function ON function_calls(function_name);
CREATE INDEX IF NOT EXISTS idx_function_calls_status ON function_calls(status);
CREATE INDEX IF NOT EXISTS idx_function_calls_timestamp ON function_calls(timestamp);
