        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="grid md:grid-cols-2 gap-4">
            <div>
              ...
              <input
                ...
                className={`w-full px-4 py-2 border-2 rounded-lg focus:ring-2 focus:ring-blue-500 outline-none transition-all bg-white dark:bg-slate-700 text-slate-900 dark:text-white placeholder:text-slate-400 ${
                  errors.age ? 'border-red-500' : 'border-slate-200 dark:border-slate-600'
                }`}
                placeholder="e.g., 8"
              />
            ...
            <div>
              ...
              <input
                ...
                className={`w-full px-4 py-2 border-2 rounded-lg focus:ring-2 focus:ring-blue-500 outline-none transition-all bg-white dark:bg-slate-700 text-slate-900 dark:text-white ${
                  errors.date_of_birth ? 'border-red-500' : 'border-slate-200 dark:border-slate-600'
                }`}
              />
          ...
          <div>
            ...
            <input
              ...
              className={`w-full px-4 py-2 border-2 rounded-lg focus:ring-2 focus:ring-blue-500 outline-none transition-all bg-white dark:bg-slate-700 text-slate-900 dark:text-white placeholder:text-slate-400 ${
                errors.medicaid_id ? 'border-red-500' : 'border-slate-200 dark:border-slate-600'
              }`}
          ...
          <div className="flex gap-3 justify-end pt-4 border-t border-slate-200 dark:border-slate-700">
            <button
              type="button"
              onClick={onCancel}
              className="px-4 py-2 bg-slate-100 dark:bg-slate-700 hover:bg-slate-200 dark:hover:bg-slate-600 text-slate-700 dark:text-slate-300 rounded-lg font-semibold transition-colors"
            >
              Cancel
            </button>
            <button
